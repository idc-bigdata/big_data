...
with open('/Users/sagi/Dropbox/MBA 2017/Data Analytics for Business/DataSet/KaggleV2-May-2016.csv', 'rb') as csvfile:
    ...
    pov_0 = ('GURIGICA','SANTA HELENA','JESUS DE NAZARETH','ILHA DO BOI','BARRO VERMELHO',
    ...
    'ENSEADA DO SU\xcc\x81','MORADA DE CAMBURI')
    pov_2 = ('BOA VISTA','MONTE BELO','AEROPORTO','PARQUE INDUSTRIAL','SANTA CLARA',
    'JARDIM CAMBURI','BENTO FERREIRA','PRAIA DO SU\xcc\x81')
    ...
    'DO MOSCOSO','ILHA DE SANTA MARIA','RESIST\xcc_NCIA','REP\xcc_BLICA','MARU\xcc\x8dPE')
    pov_4 = ('CARATO\xcc\x8dRA','HORTO','MARIA ORTIZ','JABOUR','SANTA TEREZA','CONQUISTA','DO QUADRO',
    ...
    'S\xcc\xc4O PEDRO','REDEN\xcc\xe0\xcc\xc4O','ANT\xcc\xd3NIO HON\xcc\xd2RIO')
    pov_5 = ('S\xcc\xc4O BENEDITO','SANTOS REIS','PIEDADE','SANTOS DUMONT','ESTRELINHA',
    'JOANA D\xe5\xabARC','M\xcc\x81RIO CYPRESTE','SANTO ANT\xcc\xd3NIO','INHANGUET\xcc\x81',
    'FORTE S\xcc\xc4O JO\xcc\xc4O','SANTO ANDR\xcc\xe4','ILHA DO PR\xcc\x8dNCIPE',
    'ILHAS OCE\xcc\xe2NICAS DE TRINDADE')
